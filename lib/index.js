...
var isUndef = _wangctUtil["default"].isUndef;
...
function () {
  function DOMElement(selector) {
    (0, _classCallCheck2["default"])(this, DOMElement);
    (0, _defineProperty2["default"])(this, "elemList", []);
    (0, _defineProperty2["default"])(this, "length", 0);
    this.init(selector);
  }

  (0, _createClass2["default"])(DOMElement, [{
    key: "init",
    value: function init() {
    ...
    value: function on(type, func, bol) {
      this.getList().forEach(function (item) {
        var _item$eventCache = item.eventCache,
            eventCache = _item$eventCache === void 0 ? {} : _item$eventCache;
    ...
    value: function off(type, func) {
      this.getList().forEach(function (item) {
        var _item$eventCache2 = item.eventCache,
            eventCache = _item$eventCache2 === void 0 ? {} : _item$eventCache2;
        var funcList = eventCache[type] || [];

        if (_wangctUtil["default"].isFunc(func)) {
    ...
    value: function css(key, value) {
      ...
      if (_wangctUtil["default"].isObject(key)) {
